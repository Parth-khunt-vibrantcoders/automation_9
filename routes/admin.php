...
Route::group(['prefix' => $adminPrefix, 'middleware' => ['admin']], function() {
    ...
    Route::get('update-xml-report', [DashboardController::class, 'upload_xml_report'])->name('update-xml-report');
    Route::post('save-update-xml-report', [DashboardController::class, 'save_upload_xml_report'])->name('save-update-xml-report');
    ...
    // mobile report
    Route::get('mobile-report', [MobilereportController::class, 'list'])->name('mobile-report');
    Route::post('mobile-report-ajaxcall', [MobilereportController::class, 'ajaxcall'])->name('mobile-report-ajaxcall');
    Route::get('download-excel-mobile-report', [MobilereportController::class, 'download_excel_mobile_report'])->name('download-excel-mobile-report');
